        ...
        <div className="mt-8 rounded-2xl border border-line bg-white p-6">
          ...
          <div className="mt-3 grid gap-2">
            ...
            <button
              ...
              className="inline-flex w-full items-center justify-center gap-2.5 rounded-full border border-line bg-white px-5 py-3 text-sm font-semibold text-ink transition-colors hover:border-ink/30"
            >
              <svg width="17" height="17" viewBox="0 0 24 24" aria-hidden fill="currentColor"><path d="M17.05 12.04c-.03-2.4 1.96-3.56 2.05-3.62-1.12-1.64-2.86-1.86-3.48-1.89-1.48-.15-2.89.87-3.64.87-.75 0-1.91-.85-3.14-.83-1.61.02-3.1.94-3.93 2.38-1.68 2.91-.43 7.22 1.2 9.58.8 1.16 1.75 2.46 3 2.41 1.21-.05 1.67-.78 3.13-.78 1.46 0 1.87.78 3.14.76 1.3-.02 2.12-1.18 2.91-2.34.92-1.34 1.3-2.64 1.32-2.71-.03-.01-2.53-.97-2.56-3.85zM14.63 5.16c.66-.8 1.11-1.92.99-3.03-.95.04-2.11.63-2.8 1.43-.61.71-1.15 1.85-1.01 2.94 1.06.08 2.15-.54 2.82-1.34z" /></svg>
              {a.apple}
            </button>
          </div>
        </div>
