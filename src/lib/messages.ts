...
export const fr = {
  ...
  scanner: {
    ...
    title: "Trouvez l'ingrédient qui ne vous convient pas.",
    intro: "Scannez les produits que vous avez utilisés et dites si votre peau a bien réagi ou non. Fiomio repère les ingrédients liés à vos mauvaises expériences, à éviter ensuite.",
    ...
    empty: "Aucun produit pour l'instant. Ajoutez-en quelques-uns pour révéler vos ingrédients à éviter.",
    remove: "Retirer",
    ...
    applyTitle: "Appliquer à mon diagnostic",
    applyBody: "Fiomio écartera ces ingrédients de vos prochaines recommandations.",
    applyCta: "Éviter dans mon diagnostic",
...
export const en: Messages = {
  ...
  scanner: {
    ...
    title: "Find the ingredient that doesn't agree with you.",
    intro: "Scan products you've used and tell us whether your skin reacted well or badly. Fiomio surfaces the ingredients linked to your bad experiences, to avoid next time.",
    add: "Add a product",
    tabScan: "Scan",
    tabSearch: "Search",
    ...
    empty: "No products yet. Add a few to reveal the ingredients to avoid.",
    remove: "Remove",
    ...
    applyTitle: "Apply to my diagnostic",
    applyBody: "Fiomio will steer these ingredients out of your next recommendations.",
    applyCta: "Avoid in my diagnostic",
